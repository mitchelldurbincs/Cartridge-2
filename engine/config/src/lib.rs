...
const CONFIG_SEARCH_PATHS: &[&str] = &[
    ...
    "../config.toml",   // Parent directory (when running from actor/ or web/)
...
// Lazy-loaded global config for accessor functions
static CONFIG: Lazy<CentralConfig> = Lazy::new(load_config);
